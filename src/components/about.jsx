...
const About = () => (
  <div className="main inner-container">
    ...
    <p className="main-article">
      ...
      based in Seoul, South Korea. She also worked at a regional office of
      UNESCO in Paraguay where she took a part in a project for building
      infrustructure of solar power for sustainable schools in indigenous
      communities.<br />
      <br />
